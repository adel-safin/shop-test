...
Живая витрина: https://adel-safin.github.io/shop-test/

GitHub Pages отдаёт только статику. Карусель, каталог, валюты и карточки работают. Покупка, вебхук и админка - локально через `npm start`. Vercel тут ничем не лучше: тот же статический фронт, Postgres туда не влезет.
